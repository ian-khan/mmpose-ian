...
exps = [Experiment(work_dir=Path("/work_dirs/ian_td-hm_4xrsn-alter-c_3xb64-210e_coco-384x288"),
                   exp_times="20260112_154914", label="Baseline"),
        Experiment(work_dir=Path("/work_dirs/ian_rc_td-hm_4xrsn50-c_3xb64-360e_coco-384x288"),
