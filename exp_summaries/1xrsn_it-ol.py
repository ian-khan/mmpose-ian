...
experiments = [Experiment(work_dir=Path("/work_dirs/",
                          ...
                          exp_times=["20260121_214515",
                                     ...
                                     "20260123_174904",
                                     "20260124_000245"],
                          label="E:360 LR:4e-3 PolyLR:1"),
               Experiment(work_dir=Path("/work_dirs/ian_td-hm_rsn-ian_3xb128-180e_coco-256x192_ol"),
                          exp_times=["20260124_121658",
                                     "20260125_035745"],
                          label="E:180 LR:4e-3 PolyLR:1"),
               Experiment(work_dir=Path("/work_dirs/ian_td-hm_rsn-ian_3xb128-180e_coco-256x192_lr-poly-2"),
                          exp_times=["20260125_160810",],
                          label="E:180 LR:4e-3 PolyLR:2"),
               Experiment(work_dir=Path("/work_dirs/ian_td-hm_rsn-ian_8xb32-210e_coco-256x192"),
                          exp_times=["20251126_173025"],
                          label="E:210 LR:7.5e-3 MultiStepLR"),
               ]
