...
exps = [Experiment(work_dir=Path("/work_dirs/ian_td-hm_rsn-ian_8xb32-210e_coco-256x192"),
                   exp_times=["20251126_173025"], label="M-Style 210E"),
        Experiment(work_dir=Path("/work_dirs/ian_td-hm_rsn-ian_3xb128-360e_coco-256x192_it-ol"),
